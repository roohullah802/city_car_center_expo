...
export default function SignInWithApple() {
  ...
  return (
    <TouchableOpacity activeOpacity={0.8} onPress={handlePress} style={[styles.button, { height:56 }]}>
      <View style={styles.iconWrap}>
        <Image source={require("../../../assests/apple.png")} style={styles.icon} resizeMode="contain" />
      </View>
      <View style={styles.labelWrap}>
        <Text style={styles.buttonLabel}>{loading ? <ActivityIndicator style={{justifyContent:"center", alignItems:"center"}} size={"small"} /> : 'Sign-in with Apple'}</Text>
      </View>
    </TouchableOpacity>
  );
}
